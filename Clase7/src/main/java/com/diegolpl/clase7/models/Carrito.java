...
public class Carrito {
    ...
    public double precio(){
        ...
        if(this.getTipoDescuento().matches("DF")){
//            return this.aplicarDescuentoFijo(this.getDescuento().getValorDesc());
            return this.getDescuento().valorFinal(this.total);
        }else if(this.getTipoDescuento().matches("DP")){
//            return this.aplicarDescuentoPorcentual(this.getDescuento().getValorDesc());
            return this.getDescuento().valorFinal(this.total);
        }else if(this.getTipoDescuento().matches("DPCT")){
//            return this.aplicarDescuentoPorcentual(this.getDescuento().getValorDesc());
            return this.getDescuento().valorFinal(this.total);
        }else{
            return this.total;
